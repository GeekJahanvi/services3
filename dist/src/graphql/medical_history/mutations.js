...
class Mutations {
    constructor() {
        this.ADD_MEDICAL_DOCUMENT = `mutation add_medical_documents($user_id: uuid!, $document_name: String!, $document_url: String! , $document_public_id: String!) {
...
mutation add_image_reports($user_id: uuid!, $image_url: String !, $imagename: String ! , $image_public_id: String!) {
    insert_image_reports(objects: {user_id: $user_id, image_url: $image_url, imagename: $imagename , image_public_id: $image_public_id}) {
      returning {
        ...
        this.ADD_CERTIFICATE = `mutation add_certificate($certificate_name: String!, $certificate_url: String!, $user_id: uuid! , $certificate_public_id: String!) {
...
mutation add_lab_reports($user_id: uuid !, $lab_url: String!, $filename: String!, $lab_public_id:String!) {
    insert_lab_reports(objects: {user_id: $user_id, lab_url: $lab_url, filename: $filename, lab_public_id: $lab_public_id}) {
      returning {
        ...
        this.DELETE_IMAGE_REPORT = `mutation delete_image_report($image_report_id: uuid!) {
        ...
        this.DELETE_LAB_REPORT = `mutation delete_lab_report($lab_report_id: uuid!) {
        ...
        this.DELETE_MEDICAL_DOCUMENT = `mutation delete_medical_document($medical_document_id: uuid!) {
        ...
        this.DELETE_MEDICAL_SCHOOL = `mutation delete_medical_school($medical_school_id: uuid!) {
        ...
        this.DELETE_CERTIFICATE = `mutation delete_certificate($certificate_id: uuid!) {
        ...
        this.UPDATE_IMAGE_REPORT = `mutation update_image_reports($image_id: uuid!, $imagename: String! , $image_url: String! , $image_public_id: String! ) {
        ...
        this.UPDATE_LAB_REPORT = `mutation update_lab_reports($lab_id: uuid! , $filename: String! , $lab_url: String! , $lab_public_id: String! ) {
